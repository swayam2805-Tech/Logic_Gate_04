# Logic Gates (NOR Gate using Verilog)

## Project Overview

This project demonstrates the implementation of a **basic NOR logic gate** using **Verilog HDL**. It is intended for **learners and developers** who want hands-on experience with digital logic design and FPGA implementation.

The repository includes:

* Verilog **design file** for the NOR gate 
...
* Learn how to write a simple NOR gate in Verilog
...
This waveform verifies the correct functionality of the NOR gate using the testbench.
![Waveform Simulation](Waveform.png)


### Design Schematic

Schematic view generated in Xilinx Vivado showing the NOR gate logic.
...
## Project Status
 ...
 NOR gate implemented and tested successfully
 Future scope: NOT, XOR gates
